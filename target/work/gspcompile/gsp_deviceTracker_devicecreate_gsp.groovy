...
class gsp_deviceTracker_devicecreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/device/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'device.label', default: 'Device'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',24,['bean':(deviceInstance),'var':("error")],3)
printHtmlPart(17)
})
invokeTag('hasErrors','g',26,['bean':(deviceInstance)],2)
printHtmlPart(10)
createTagBody(2, {->
printHtmlPart(18)
...
invokeTag('form','g',34,['url':([resource:deviceInstance, action:'save'])],2)
printHtmlPart(21)
})
...
public static final long LAST_MODIFIED = 1402618467408L
