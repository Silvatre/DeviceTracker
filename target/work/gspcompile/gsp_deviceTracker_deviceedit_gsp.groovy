...
class gsp_deviceTracker_deviceedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/device/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'device.label', default: 'Device'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',26,['bean':(deviceInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(deviceInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
invokeTag('hiddenField','g',30,['name':("version"),'value':(deviceInstance?.version)],-1)
printHtmlPart(20)
...
invokeTag('form','g',37,['url':([resource:deviceInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(23)
})
...
public static final long LAST_MODIFIED = 1402618460441L
