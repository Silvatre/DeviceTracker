...
class gsp_deviceTracker_layoutsbootstrap_theme_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/layouts/bootstrap_theme.gsp" }
public Object run() {
Writer out = getOut()
...
public static final long LAST_MODIFIED = 1402613391010L
